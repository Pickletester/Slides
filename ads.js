document.addEventListener('DOMContentLoaded', function() {
    ...
    // Using 'var' instead of 'const' for older browsers
    var adPlaylist = [
    ...
    var player = document.getElementById('adPlayer');
